...
object libcurl {
  ...
  @name("CURLOPT_URL_STRINGPOINT")
  val CURLOPT_URL: CURLoption = native.extern

  /*
   How do we represent this method, particularly the parameter which can be a long, function pointer, object pointer, or curl_off_t?
